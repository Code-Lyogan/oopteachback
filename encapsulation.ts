...
class MyClass1 {
  ...
  // To make the MyProperty accessible from outside the class, we will
  ...
  // these methods are both public and can be accessed outside of the class
    ...
    // We have a method named 'doSomething()' that prints our string concat'd with the current value of the property.
    doSomething(): void {
      console.log(`The value of myProperty is ${this._myProperty}`);
    }
  }

  // the 'private' keyword before variable '_myProperty' means the variable cannot be
